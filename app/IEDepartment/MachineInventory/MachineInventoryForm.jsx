...
export default function MachineInventoryForm({ onSaveSuccess }) {
  ...
  useEffect(() => {
    if (machineName && floorName) loadFloorData(machineName, floorName);
  ...
  return (
    <div className="min-h-screen bg-[#0f1117] flex items-start justify-center px-4 py-10 font-mono">
      ...
      {toast && (
        <div
          className={`fixed top-5 right-5 z-50 px-5 py-3 rounded-lg text-sm font-semibold shadow-2xl border transition-all duration-300 ${
            toast.type === "success"
