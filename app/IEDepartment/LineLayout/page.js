...
import MachineInventoryForm  from "../MachineInventory/MachineInventoryForm";
import MachineInventoryTable from "../MachineInventory/MachineInventoryTable";
...
export default function Page() {
  ...
  return (
    /*
      KEY FIX:
        - Remove `w-screen` (it ignores sidebar padding → overflows behind sidebar)
        - Use `w-full` instead — fills exactly the space AFTER the sidebar's paddingLeft
        - The scale wrapper uses width: "149.25%" (relative to parent) not "149.25vw"
    */
    <div className="w-full bg-[#0f1117] overflow-hidden" style={{ height: "100vh" }}>
      <div
        style={{
          transform: "scale(0.67)",
          transformOrigin: "top left",
          width:  "149.25%",    /* 100% / 0.67 — relative to parent, not viewport */
          height: "149.25vh",
        }}
      ...
      >
        ...
        <div className="flex flex-1 overflow-hidden relative">
          ...
          {/* Backdrop — scoped to body container, not full viewport */}
          {formOpen && (
            <div
